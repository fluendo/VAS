...
namespace VAS.Tests
{
	...
	public class TestPlaylistManager
	{
		...
		Mock<IRenderingJobsController> mockVideoRenderer;
		...
		public void FixtureSetup ()
		{
			...
			mockVideoRenderer = new Mock<IRenderingJobsController> ();
		...
		public void Setup ()
		{
			...
			App.Current.RenderingJobsController = mockVideoRenderer.Object;
			mockDiaklogs = new Mock<IDialogs> ();
