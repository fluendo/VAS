...
namespace VAS.Tests.Services
{
	...
	public class TestDrawingsController
	{
		...
		[Test]
		public void SetViewModel_VideoPlayerOnly ()
		{
		...
		[Test]
		public void SetViewModel_VideoPlayerAndProject ()
		{
			var viewModel = new Mock<IViewModel> ();
			var playerDealer = viewModel.As<IVideoPlayerDealer> ();
			playerDealer.SetupGet (vm => vm.VideoPlayer).Returns (videoPlayer);
		...
		[Test]
		public void DrawFrame_WithTimelineEventNewDrawing ()
		{
			var viewModel = new Mock<IViewModel> ();
			var playerDealer = viewModel.As<IVideoPlayerDealer> ();
			playerDealer.SetupGet (vm => vm.VideoPlayer).Returns (videoPlayer);
		...
		[Test]
		public void DrawFrame_WithTimelineEventExistingDrawing ()
		{
			var viewModel = new Mock<IViewModel> ();
			var playerDealer = viewModel.As<IVideoPlayerDealer> ();
			playerDealer.SetupGet (vm => vm.VideoPlayer).Returns (videoPlayer);
		...
		[Test]
		public void DrawFrame_WithoutTimelineEvent ()
		{
			var viewModel = new Mock<IViewModel> ();
			var playerDealer = viewModel.As<IVideoPlayerDealer> ();
			playerDealer.SetupGet (vm => vm.VideoPlayer).Returns (videoPlayer);
		...
		[Test]
		public void DrawFrame_CurrentFrame ()
		{
			var viewModel = new Mock<IViewModel> ();
			var playerDealer = viewModel.As<IVideoPlayerDealer> ();
			playerDealer.SetupGet (vm => vm.VideoPlayer).Returns (videoPlayer);
